                ...
                <div class="relative ml-3" id="profileDropdownContainer">
                    ...
                    <div>
                        <button type="button" 
                            ...
                            <div class="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold border border-blue-200 shadow-sm">
                    ...
                    <div id="user-menu-dropdown"
                        ...
                        <div class="px-4 py-3 border-b border-gray-100">
                            ...
                            <p class="text-xs text-gray-500 truncate mb-1">{{ Auth::user()->email }}</p>
                            <!-- <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800">
                                Administrator
                            </span> -->
                        </div>
